...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lb38bkq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lb38bkq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bennysam171/container-lb38bkq.git
cd container-lb38bkq
```
...
```
docker attach container-lb38bkq
```
